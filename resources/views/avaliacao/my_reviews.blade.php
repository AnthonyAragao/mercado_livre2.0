...
@section('insert_body')
    ...
    <main>
        ...
        <div class="container">
            ...
            <span>Dê sua opinião e ajude a mais pessoas</span>
            {{-- {{dd($compras[0]->exemplar->first()->pivo->produto )}} --}}
                            ...
                            <div style="
                                ...
                                <div style="display: flex; gap: 11px; justify-content: center; margin-top: 15px">
                                    ...
                                    <div style="display: flex; flex-direction: column;">
                                        <a href=""><i class="fa-regular fa-star fa-2xl" style="color: #a7a4a4"></i></a>
